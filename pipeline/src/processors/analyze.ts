...
/**
 * Analisa transcrição com Claude Haiku e seleciona os melhores trechos pra Shorts.
 * Retorna Segment[] ordenados por score de viralidade.
 */
...
${transcript}`
  ...
  // Extrair JSON da resposta (Haiku pode incluir texto antes/depois do array)
