...
/**
 * Upload de arquivo pro Cloudflare R2 e retorna URL pública.
 * Usa S3-compatible API com AWS Signature V4 manual (sem SDK).
 */
export async function uploadToR2(filePath: string, key?: string): Promise<string> {
  ...
  // AWS Signature V4 — cabeçalhos canônicos
  ...
  // Retornar URL pública se configurada, senão URL direta do bucket
  if (publicUrl) {
